...
(function () {
    var Memory = {
        ...
        init: function (cards) {
            ...
            this.buildHTML = this.buildColorCardHTML;
            this.currentCardCollection = "cardCollection3";
            /*
        ...
        // This builds the HTML of plain color cards. Expects an color field in the collection
        buildColorCardHTML: function () {

            var frag = '';
            this.$cards.each(function (k, v) {
                frag += '<div class="card" data-id="' + v.id + '"><div class="inside">\
				<div class="front" style="background-color:'+v.color+';">&nbsp;</div>\
				<div class="back"><img src="images/eagleHead.svg"\
				alt="Eagle Head Logo" /></div></div>\
				</div>';
            });
